---
title: "Curiosity-Driven Learning: Why I Build Random Stuff"
date: 2022-01-10
type: "learning"
description: "Why I build seemingly random projects: a file system in Java, Discord bots, a development server. Each project is a way to deeply understand how something works."
skills:
  - "Exploration"
  - "Reverse Engineering"
  - "Self-Teaching"
...
- Discord bots for fun and moderation (at first in JS, following tutorials and docs, not understanding much, and only much later discovering JDA and the Java ecosystem)
- A development server to host everything
