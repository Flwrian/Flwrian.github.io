...
duration: "1.5 years"
teamSize: 5
outcomeSummary: "Architected and developed scalable data and file management solutions for B2B IoT platform managing everything from solar farms to connected badges. Led architectural decisions, designed APIs, and implemented core features."
